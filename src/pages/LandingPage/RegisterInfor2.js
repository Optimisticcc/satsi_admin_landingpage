...
const headCells = [
  { label: 'STT', id: 'STT' },
  { label: 'Tên', id: 'name' },
  { label: 'Số điện thoại', id: 'phoneNumber' },
  { label: 'Email', id: 'email' },
  { label: 'Nội dung', id: 'Nội dung' },
  { label: 'Ngày đăng ký', id: 'created_at' },
];
...
export default function RegisterInfo2() {
  ...
  useEffect(() => {
    ...
    const getCollaborates = async () => {
      const res = await getDataApi.getRegisterInfo(params);
      console.log(res);
